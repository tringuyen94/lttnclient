...
const AsideAccessories = ({ brands, dispatch, getConvertersFilter }) => {
    ...
    return (
        <div className="aside">
            ...
            <div className="checkbox-filter">{renderAccessoriesBrands()}</div>
...
export default connect(mapStateToProps)(AsideAccessories)
